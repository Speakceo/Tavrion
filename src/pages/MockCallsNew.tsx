...
export function MockCallsNew() {
      ...
      try {
        ...
        recognition.onresult = async (event: any) => {
          ...
          if (transcript.trim()) {
            ...
            await sendMessageAuto(transcript);
            setIsTranscribing(false);
          }
        };
  ...
  const endCall = async () => {
    ...
    try {
      const response = await fetch(`${SUPABASE_URL}/functions/v1/openrouter-mock-call-evaluate`, {
        method: 'POST',
        headers: {
        ...
        <div className="relative overflow-hidden bg-gradient-to-br from-blue-600 via-blue-700 to-cyan-600 rounded-2xl p-8 text-white shadow-2xl">
          ...
          <div className="relative">
            <div className="flex items-center space-x-2 mb-3">
              ...
              <span className="text-sm font-semibold uppercase tracking-wider opacity-90">Practice Calls</span>
            </div>
            <h1 className="text-4xl font-bold mb-2">Practice Real Conversations</h1>
            <p className="text-blue-100 text-lg">Master objection handling with realistic scenarios</p>
          </div>
        </div>
